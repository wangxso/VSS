...
class Calibration:
    def __init__(self,calibration_file):
        ...
        print(len(self.accelerations))
        print(len(self.commands))
        self.interp_func = self.create_interp2d()

    def create_interp2d(self):
        # 创建双线性插值函数
        return interp2d(self.speeds, self.commands, self.accelerations, kind='linear')
...
class trafficControl:
    ...
    def traffic_control_to_action(self,speed,throttle,brake,steer):
    # 直行判断
        if steer == 0.0:
